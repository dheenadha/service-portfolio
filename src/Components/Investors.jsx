...
const Investors = () => {
  return (
    <div>
      <h1 className="text-5xl text-center text-blue-500/70">Investors</h1>
      <div className="flex gap-10 justify-center items-center mt-12">
        {/* Card 1 */}
        <div className="w-[300px] h-[25rem] bg-[#fff] rounded-2xl border-[3px] border-blue-500/50 shadow-lg shadow-blue-500/100 transition-all duration-400 ease-in hover:-translate-y-6 hover:border-blue-500/75 hover:rounded-[6rem_0_6rem_0] flex flex-col items-center justify-center p-6">
          <div>
        ...
        <div className="w-[300px] h-[25rem] bg-[#fff] rounded-2xl border-[3px] border-blue-500/50 shadow-lg shadow-blue-500/100 transition-all duration-400 ease-in hover:-translate-y-6 hover:border-blue-500/75 hover:rounded-[6rem_0_6rem_0] flex flex-col items-center justify-center p-6">
          ...
          <h2 className="text-gray-800 text-xl font-semibold mb-1 shadow-sm border-[2px] border-blue-500/25 bg-blue-500/25 rounded-xl w-44 text-center shadow-blue-500/75">
            A.Kathiravan
          </h2>
